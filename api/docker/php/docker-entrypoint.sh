...
if [ "$1" = 'php-fpm' ] || [ "$1" = 'php' ] || [ "$1" = 'bin/console' ]; then
	...
	if [ "$APP_ENV" = 'dev' ]; then
        ...
        sed -i.bak "s/^MAILER_DSN=smtp://localhost$/MAILER_DSN=smtp://${GMAIL_USERNAME}:${GMAIL_PASSWORD}@gmail/" .env.local
        ...
        sed -i.bak "s/'MAILER_DSN' => 'smtp://localhost',$/'MAILER_DSN' => 'smtp://${GMAIL_USERNAME}:${GMAIL_PASSWORD}@gmail',/" .env.local.php
